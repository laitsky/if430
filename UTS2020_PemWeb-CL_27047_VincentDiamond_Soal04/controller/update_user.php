...
$success = $error = $id = $nama_depan = $nama_belakang = $role = $alamat = "";
...
if (isset($_POST['update_user'])) {
    ...
    sql_query("UPDATE `user` SET `first_name`='$nama_depan', `last_name`='$nama_belakang', `role_id`='$role', `address`='$alamat' WHERE `user_id` = '$id'");
