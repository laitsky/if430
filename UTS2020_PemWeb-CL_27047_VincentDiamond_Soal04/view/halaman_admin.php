                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <h6>Apakah kamu yakin ingin menghapus <span style="font-weight: bolder;"><?php echo $row->get_name(); ?></span>?</h6>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
                            <a href="../controller/hapus_user.php?user_id=<?php echo $row->get_user_id(); ?>" class="btn btn-danger">Hapus!</a>
                        </div>
                    </div>
                </div>
            </div>
